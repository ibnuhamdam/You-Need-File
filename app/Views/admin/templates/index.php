...
<head>
    ...
    <title>You Need | Dashboard Admin</title>

    <link rel="shortcut icon" href="<?= base_url() ?>/icon/favicon.png" type="image/x-icon">
    <!-- Custom fonts for this template-->
    <link href="<?= base_url(); ?>/admin-asset/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; You Need Files <?= date('Y') ?></span>
                        <!-- <span class="mt-2">Created By IHMS</span> -->
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Sure Wants to Leave?</h5>
    ...
    <script src="<?= base_url(); ?>/admin-asset/vendor/jquery/jquery.min.js"></script>
    <script src="<?= base_url(); ?>/admin-asset/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="<?= base_url(); ?>/admin-asset/vendor/jquery-easing/jquery.easing.min.js"></script>
