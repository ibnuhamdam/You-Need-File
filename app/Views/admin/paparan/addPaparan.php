...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('admin/files/paparan/insert') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="row">
                    <div class="col-12 col-md-8">
                        <form enctype="multipart/form-data" method="POST" action="<?= base_url('admin/files/paparan/insert') ?>">
                            ...
                            <div class="form-group">
                                <label for="input-fa">Upload Files Paparan</label>
                                <div class="file-loading">
                                    <input id="input-fa" class="" name="paparan[]" type="file" accept=".pdf" multiple>

                                </div>
                                <input type="hidden" class="<?php if (session('errors.paparan')) : ?>is-invalid<?php endif ?>">
